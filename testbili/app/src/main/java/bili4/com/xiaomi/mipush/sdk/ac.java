package bili4.com.xiaomi.mipush.sdk;
...
public class ac {
    ...
    private Thread t = new Thread(new ixe(this));
    ...
    private ac(Context context) {
        ...
        this.b = n();
        n = y();
        this.q = new ixf(this, Looper.getMainLooper());
        Intent p = p();
        if (p != null) {
            a(p);
            a = true;
    ...
    private void B() {
        ...
        this.j.bindService(intent, new ixi(this), 1);
    }
    ...
    L_0x0033:
        ...
        r10.d(r1);	 Catch:{ Throwable -> 0x002d }
        goto L_0x0012;
    L_0x0048:
        r1 = r9.b;	 Catch:{ Throwable -> 0x002d }
        r2 = "title";
    ...
    private final void a(String str, aj ajVar, boolean z, HashMap<String, String> hashMap) {
        ...
        hashMap2.put(IjkMediaMeta.IJKM_KEY_TYPE, ajVar);
    ...
    private synchronized void b(int i) {
        this.j.getSharedPreferences(MiPushClient.PREF_EXTRA, 0).edit().putInt("service_boot_mode", i).commit();
    }
    ...
    private void b(String str, aj ajVar, boolean z, HashMap<String, String> hashMap) {
        if (c.a(this.j).b() && d.c(this.j)) {
            ...
            if (TextUtils.isEmpty(str)) {
                b = MiPushClient.b();
                aiVar2.a((String) b);
                ai aiVar3 = z ? new ai(b, true) : null;
                synchronized (u.class) {
                    u.a(this.j).a((String) b);
                }
                aiVar = aiVar3;
            } else {
                aiVar2.a(str);
            ...
            if (z) {
                ...
                byte[] a = au.a(x.a(this.j, aiVar, com.xiaomi.xmpush.thrift.a.Notification, false, this.j.getPackageName(), c.a(this.j).c()));
                if (a != null) {
                    o.putExtra("mipush_payload", a);
    ...
    private synchronized void c(Intent intent) {
        if (this.s) {
            ...
            ixh bl_ixh = new ixh(this);
            Context context2 = this.j;
            context.bindService(intent, bl_ixh, 1);
            this.s = true;
            this.r.clear();
            this.r.add(d(intent));
        } else {
    ...
    private synchronized int k() {
        return this.j.getSharedPreferences(MiPushClient.PREF_EXTRA, 0).getInt("service_boot_mode", -1);
    }
    ...
    public void a(String str, String str2) {
        HashMap hashMap = new HashMap();
        hashMap.put(SocialConstants.PARAM_TITLE, str);
    ...
    public boolean c(int i) {
        ...
        aiVar.a(MiPushClient.b());
        aiVar.b(c.a(this.j).c());
        aiVar.d(this.j.getPackageName());
        aiVar.c(r.ClientABTest.W);
        aiVar.h = new HashMap();
        aiVar.h.put("boot_mode", i + bj.b);
    ...
    public boolean h() {
        ...
        if (this.v == null) {
            ...
            if (this.v.intValue() == 0) {
                this.j.getContentResolver().registerContentObserver(com.xiaomi.push.service.au.a(this.j).c(), false, new ixg(this, new Handler(Looper.getMainLooper())));
            }
        }
