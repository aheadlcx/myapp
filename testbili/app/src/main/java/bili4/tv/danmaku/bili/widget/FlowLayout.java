...
public class FlowLayout extends ViewGroup {
    ...
    public static class a extends MarginLayoutParams {
        ...
        private void a(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.ag);
            try {
    ...
    public FlowLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.bG);
        try {
            ...
            if (this.f) {
                ...
                this.g = obtainStyledAttributes.getInteger(2, Tag.INVALID_ID);
            }
            if (this.f && this.b != 0) {
                this.b = 0;
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (i4 = 0; i4 < childCount; i4++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                Object obj = (aVar.a || !(i3 == 0 || b.b(childAt))) ? 1 : null;
                if (obj == null) {
                    bVar = b;
                    mode = i6;
                } else if (i6 == this.g - 1) {
