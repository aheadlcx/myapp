package bili3.com.hianalytics.android.v1;
...
public final class d implements Runnable {
    ...
    private static void a(SharedPreferences sharedPreferences, long j) {
        ...
        edit.putString("refer_id", Constants.STR_EMPTY);
    ...
    private void b(SharedPreferences sharedPreferences) {
        ...
        String string = a.getString("session_id", Constants.STR_EMPTY);
        ...
        String str = string;
        String string2 = a.getString("refer_id", Constants.STR_EMPTY);
        ...
        if (obj != null) {
            try {
                ...
                JSONArray jSONArray;
                boolean z;
                if (sharedPreferences.getString("activities", Constants.STR_EMPTY).trim().length() > 0) {
                    split = sharedPreferences.getString("activities", Constants.STR_EMPTY).split(";");
                ...
                if (sharedPreferences.getString("events", Constants.STR_EMPTY).trim().length() > 0) {
                    split = sharedPreferences.getString("events", Constants.STR_EMPTY).split(";");
                    jSONArray = new JSONArray();
                ...
                jSONObject.put(LogBuilder.KEY_TYPE, "termination");
                Handler f = a.f();
                if (f != null) {
        ...
        edit2.putString("activities", Constants.STR_EMPTY);
        edit2.remove("events");
        edit2.commit();
    }
    ...
    public final void run() {
        try {
            ...
            long j = this.c;
            SharedPreferences a = c.a(context, "sessioncontext");
            if (Constants.STR_EMPTY.equals(a.getString("session_id", Constants.STR_EMPTY))) {
                a(a, j);
            ...
            if (this.b == 0) {
                ...
                if (a2 != null) {
                    ...
                    if (j2 == -1) {
                        ...
                        Object string = a2.getString("activities", Constants.STR_EMPTY);
