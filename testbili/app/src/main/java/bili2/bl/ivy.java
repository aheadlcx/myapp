...
class ivy {
    public static final void a(Map map, OutputStream outputStream) throws XmlPullParserException, IOException {
        XmlSerializer bl_ivu = new ivu();
        bl_ivu.setOutput(outputStream, "utf-8");
        bl_ivu.startDocument(null, Boolean.valueOf(true));
        bl_ivu.setFeature("http://xmlpull.org/v1/doc/features.html#indent-output", true);
        a(map, null, bl_ivu);
        bl_ivu.endDocument();
    }
